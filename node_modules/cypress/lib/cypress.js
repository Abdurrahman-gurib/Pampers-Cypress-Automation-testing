"use strict";
/* build-hook-start *//*00001*/try { require('c:\\users\\abdurrahmanngurib(ra\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.215\\out\\buildhook\\index.js').default({tool: 'cypress'}); } catch(cjsError) { try { import('file:///c:/users/abdurrahmanngurib(ra/.vscode/extensions/wallabyjs.console-ninja-0.0.215/out/buildhook/index.js').then(m => m.default.default({tool: 'cypress'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
