...
["en-US"].forEach((registrationScopeElement) => {
    ...
    describe(`Registration for ${registrationScopeElement} on ${crmProperties.env}`, () => {
        ...
        it(`go to registration page`, () => {
            ...
            cy.intercept(globalThis.params.appProperties.apiToWaitBeforeTest.method,
                ...
                cy.get(crmProperties.registration.properties[registrationScopeElement].newNav ? crmSelector.newNav.registrationNavigationMenu : crmSelector.registration.registrationNavigationMenu, {timeout: 5000}).click({force: true});
        ...
        it(`complete registration form`, () => {
            ...
            cy.genericRegistrationForm(crmProperties.registration.properties[registrationScopeElement].fields,
                    registrationScopeElement, crmProperties.registration.properties[registrationScopeElement].marketConfig, { timeout: 1000 });
        });
        it(`verify thank you page`, () => {
            ...
            cy.url().should('include', crmProperties.registration.properties[registrationScopeElement].localizedPath.thankYou);
        ...
        it(`verify login used for registration`, () => {
            ...
            cy.wait(2500);
            cy.get(crmSelector.editProfile.email, {timeout: 15000}).should("have.attr", "value")
