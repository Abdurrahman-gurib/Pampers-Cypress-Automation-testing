...
(getCrmMarketsScope(crmProperties.registration)).forEach((registrationScopeElement) => {
    ...
    describe(`Registration for ${registrationScopeElement} on ${crmProperties.env}`, () => {
        ...
        it(`complete registration form`, () => {
            ...
            cy.genericRegistrationForm(crmProperties.registration.properties[registrationScopeElement].fields, registrationScopeElement, crmProperties.registration.properties[registrationScopeElement].marketConfig || null);
        });
