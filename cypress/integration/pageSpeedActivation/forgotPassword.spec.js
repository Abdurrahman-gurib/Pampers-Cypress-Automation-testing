...
(getCrmMarketsScope(crmProperties.forgotPassword)).forEach((forgotPasswordScopeElement) => {
    describe(`Forgot Password for ${forgotPasswordScopeElement} on ${crmProperties.env}`, () => {
        ...
        it(`complete email then submit form`,() => {
            ...
            cy.url().should(`include`, crmProperties.forgotPassword.properties[forgotPasswordScopeElement]);
